 ...
 */
miApp.controller('_usuarioController', ['$scope', '$route', '$timeout', '$cookies', 'Upload', '$location', '_usuarioService', 'factoryCache', '$rootScope', function ($scope, $route, $timeout, $cookies, Upload, $location, _usuarioService, factoryCache, $rootScope) {

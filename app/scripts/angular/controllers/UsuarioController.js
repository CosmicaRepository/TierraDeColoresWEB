...
var usuarioController = miAppHome.controller('UsuarioController', ['$scope', 'toaster', '$route', '$timeout', '$cookies', 'Upload', '$location', 'UsuarioService', '$rootScope', function ($scope, toaster, $route, $timeout, $cookies, Upload, $location, UsuarioService, $rootScope) {
